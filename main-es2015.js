...
const routes = [
    ...
    { path: 'accordion', loadChildren: () => __webpack_require__.e(/*! import() | accordion-accordion-module */ "accordion-accordion-module").then(__webpack_require__.bind(null, /*! ./accordion/accordion.module */ "./src/app/accordion/accordion.module.ts")).then(m => m.AccordionModule) },
    { path: 'tooltip', loadChildren: () => __webpack_require__.e(/*! import() | tooltip-tooltip-module */ "tooltip-tooltip-module").then(__webpack_require__.bind(null, /*! ./tooltip/tooltip.module */ "./src/app/tooltip/tooltip.module.ts")).then(m => m.TooltipModule) },
    { path: 'datepicker', loadChildren: () => __webpack_require__.e(/*! import() | datepicker-datepicker-module */ "datepicker-datepicker-module").then(__webpack_require__.bind(null, /*! ./datepicker/datepicker.module */ "./src/app/datepicker/datepicker.module.ts")).then(m => m.DatepickerModule) },
    { path: 'dropdown', loadChildren: () => __webpack_require__.e(/*! import() | dropdown-dropdown-module */ "dropdown-dropdown-module").then(__webpack_require__.bind(null, /*! ./dropdown/dropdown.module */ "./src/app/dropdown/dropdown.module.ts")).then(m => m.DropdownModule) },
    { path: 'getting-started', loadChildren: () => __webpack_require__.e(/*! import() | getting-started-getting-started-module */ "getting-started-getting-started-module").then(__webpack_require__.bind(null, /*! ./getting-started/getting-started.module */ "./src/app/getting-started/getting-started.module.ts")).then(m => m.GettingStartedModule) },
    { path: 'modal', loadChildren: () => __webpack_require__.e(/*! import() | modal-modal-module */ "modal-modal-module").then(__webpack_require__.bind(null, /*! ./modal/modal.module */ "./src/app/modal/modal.module.ts")).then(m => m.ModalModule) },
...
let AppComponent = class AppComponent {
    constructor(router, mobileDetectService) {
        this.router = router;
        ...
        this.$selected = router.events
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((event) => Object.values(this.routes)
            .find((value) => value.path === event.url)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((route) => route.name));
    }
    handleScroll() {
    ...
    toggleBodyLock(show, templateRef) {
...
let MobileDetectService = class MobileDetectService {
    constructor() {
    ...
    isMobile() {
        const md = new mobile_detect__WEBPACK_IMPORTED_MODULE_2__(this.nativeWindow.navigator.userAgent);
        return !!md.mobile();
    }
};
