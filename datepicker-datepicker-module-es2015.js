...
const routes = [{ path: '', component: _datepicker_component__WEBPACK_IMPORTED_MODULE_3__["DatepickerComponent"] }];
let DatepickerRoutingModule = class DatepickerRoutingModule {
};
...
let DatepickerSimpleComponent = class DatepickerSimpleComponent {
...
DatepickerSimpleComponent.ctorParameters = () => [
