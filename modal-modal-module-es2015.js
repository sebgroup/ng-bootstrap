...
const routes = [{ path: '', component: _modal_component__WEBPACK_IMPORTED_MODULE_3__["ModalComponent"] }];
let ModalRoutingModule = class ModalRoutingModule {
};
...
let ModalComponent = class ModalComponent {
    constructor(document, modalService) {
        this.document = document;
        this.modalService = modalService;
        this.modal = false;
    }
    open(content, options) {
        const modalRef = this.modalService.open(content, Object.assign({}, options, { ariaLabelledBy: 'modal-basic-title' }));
