...
const routes = [{ path: '', component: _accordion_component__WEBPACK_IMPORTED_MODULE_3__["AccordionComponent"] }];
let AccordionRoutingModule = class AccordionRoutingModule {
};
